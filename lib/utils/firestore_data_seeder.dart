    ...
    final sampleProducts = [
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/10657976/pexels-photo-10657976.jpeg',
        'stock': 25,
        'isActive': true,
        'isFeatured': true,
        'isOnSale': true,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/8250983/pexels-photo-8250983.jpeg',
        'stock': 10,
        'isActive': true,
        'isFeatured': false,
        'isOnSale': false,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/10292806/pexels-photo-10292806.jpeg',
        'stock': 40,
        'isActive': true,
        'isFeatured': true,
        'isOnSale': true,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/29730990/pexels-photo-29730990.jpeg',
        'stock': 30,
        'isActive': true,
        'isFeatured': true,
        'isOnSale': false,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/4252970/pexels-photo-4252970.jpeg',
        'stock': 50,
        'isActive': true,
        'isFeatured': false,
        'isOnSale': true,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/26736140/pexels-photo-26736140.jpeg',
        'stock': 20,
        'isActive': true,
        'isFeatured': true,
        'isOnSale': false,
        ...
        'specifications': {'color': 'Brown', 'material': 'Leather', 'weight': '0.5kg'},
        'createdAt': FieldValue.serverTimestamp(),
        'updatedAt': FieldValue.serverTimestamp(),
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/27638168/pexels-photo-27638168.jpeg',
        'stock': 18,
        'isActive': true,
        'isFeatured': false,
        'isOnSale': true,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/5944189/pexels-photo-5944189.jpeg',
        'stock': 35,
        'isActive': true,
        'isFeatured': true,
        'isOnSale': true,
      ...
      },
      {
        ...
        'primaryImage': 'https://images.pexels.com/photos/6339731/pexels-photo-6339731.jpeg',
        'stock': 60,
        'isActive': true,
        'isFeatured': false,
        'isOnSale': true,
        ...
        'specifications': {'color': 'Green', 'material': 'TPE', 'length': '183cm'},
        'createdAt': FieldValue.serverTimestamp(),
        'updatedAt': FieldValue.serverTimestamp(),
      },
    ];
